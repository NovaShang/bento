...
extension AgentWorkspaceStore {
    ...
    package func catalogUpsert(pane: PaneEntry, lastActive: Date? = nil) {
    ...
    package func catalogNoteActivity(paneID: Int) {
    ...
    package static func presetForCatalogID(_ presetID: String) -> (ACPAgentPreset, String?) {
    ...
    package func presetFor(_ entry: PaneEntry) -> ACPAgentPreset {
