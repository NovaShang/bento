...
/// The focused pane's working directory as a browsable tree — the macOS dock's
/// permanent "Files" tab and the iOS preview sheet's browser, one
/// implementation. Built from the same bounded listing as tap-to-preview
/// (`listTree`: depth ≤ 4 / 2000 entries), so it's "browse the project you're
/// working in", not a general file manager. Tapping a file calls `onOpenFile`.
