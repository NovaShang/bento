...
public final class AgentSessionViewModel: ObservableObject, Identifiable {
    ...
    package var onSessionTitleChange: (@MainActor () -> Void)?
    ...
    package var onConnectionLost: (@MainActor () -> Void)?
    ...
    /// in-place growth.
    package let transcriptDidGrow = PassthroughSubject<Void, Never>()
    ...
    package func handleHostEvent(_ event: AcpHostEvent) {
        switch event {
        case .agentExited:
    ...
    package func makeBridge() -> SessionConnectionBridge {
        bridge?.session = nil
    ...
    package func handle(_ notification: SessionNotification) {
    ...
    package func replayProducingNothingForTests() {
        beginReplay()
        endReplay()
    }
    ...
    package func presentPermission(
    ...
    package func presentElicitation(
    ...
    package func handleConnectionClosed(error: Error?) {
        isReconnecting = false
        cancelAllPrompts()
        forceEndReplay()
        closeStreams()
