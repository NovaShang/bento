...
/// Package-wide door to this target's resource bundle (PathPreview template
/// + vendored JS). SPM's generated `Bundle.module` accessor is `internal` to
/// this target and lives in DerivedSources, so it cannot be widened directly;
/// this forwarder gives the rest of the package (the umbrella's tests) the
/// same bundle.
extension Foundation.Bundle {
    package static var bentoFilePreviewKit: Bundle { .module }
}
