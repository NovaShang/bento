...
public final class WorkspaceViewModel: ObservableObject {
    ...
    public let host: BentoFoundation.Host
    ...
    public init(host: BentoFoundation.Host, workspace: AgentWorkspaceStore,
    ...
    package static func doneUnseen(isFocused: Bool, newState: PaneState,
