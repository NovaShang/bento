...
package enum ImageAttachmentProcessor {
    package static let maxPixelSize = 1568
    ...
    package static let agentSafeMIMETypes: Set<String> = [
        "image/png", "image/jpeg", "image/gif", "image/webp",
    ]

    package static func process(_ data: Data) -> (data: Data, mimeType: String)? {
