...
public final class TiledPaneHost: NSView, NSMenuDelegate {
    ...
    private func layoutCells() {
        ...
        // Focus mode: the sidebar (and, in Focus, the agent-level title bar)
        // already carry the name + state + pane actions — a title bar on the
        // single pane would be that chrome twice, so the pane owns the full area.
